...
<head>
	<meta charset="UTF-8">
	<title>Economic Crime (Transparency and Enforcement) Act 2022 | legislation.gov.uk</title>
	<noscript>
	...
	<main class="legislation">
		<section>
			<nav aria-label="Breadcrumb">
				<h2>Where this legislation sits in the Statute Book</h2>
				<ol>
					<li><a href="#">UK Public General Acts</a></li>
					<li><a href="#">2022</a></li>
					<li><a href="#" aria-current="page">Chapter 10</a></li>
				</ol>
			</nav>
			<h1 id="main-content-h" tabindex="-1">
				Economic Crime (Transparency and Enforcement) Act 2022 
				<br class="initialise"><span>The whole Act</span>
			</h1>
		</section>
		...
		<div class="legislation-content">
			...
			<div>
				<section class="legislation-text">
					<h2>Legislation text for the whole Act</h2>
					(PDF of legislation text)
				</section>
			</div>
			<aside>
