...
<head>
	<meta charset="UTF-8">
	<title>How legislation works | Help and guidance | legislation.gov.uk</title>
	<noscript>
		...
		<section>
			<nav aria-labelledby="breadcrumbNavigation">
				...
				<ol>
					...
					<li><a href="help-how-legislation-works.php" aria-current="page">How legislation works</a></li>
				</ol>
			</nav>
			<h1 id="main-content-h" tabindex="-1">How legislation works</h1>
		</section>
		<section class="cards">
			<p>Find out how different types of legislation get made in various parts of the United Kingdom, how legislation come into force, and how it is amended.</p>
			<h2>Main sections in How legislation works</h2>
			<ul>
				<li>
					<article>
						<a href="#"><h3>How legislation is made</h3></a>
					</article>
				</li>
				<li>
					<article>
						<a href="#"><h3>Parliaments and jurisdictions</h3></a>
					</article>
				</li>
				<li>
					<article>
						<a href="#"><h3>How legislation comes into force</h3></a>
					</article>
				</li>
				<li>
					<article>
						<a href="#"><h3>Understanding geographical extent</h3></a>
					</article>
				</li>
				<li>
					<article>
						<a href="#"><h3>The statute book</h3></a>
					</article>
				</li>
				<li>
					<article>
						<a href="#"><h3>Primary legislation explained</h3></a>
					</article>
				</li>
				<li>
					<article>
						<a href="help-secondary-legislation-explained.php"><h3>Secondary legislation explained</h3></a>
					</article>
				</li>
				<li>
					<article>
						<a href="#"><h3>Numbering for primary and secondary legislation</h3></a>
					</article>
				</li>
				<li>
					<article>
						<a href="help-revised-legislation-explained.php">
							<h3>Revised legislation explained</h3>
						</a>
					</article>
				</li>
			</ul>
