...
<head>
	<meta charset="UTF-8">
	<title>Legislation for the United Kingdom | Different legislatures of the UK | Explore our collections | legislation.gov.uk</title>
	<noscript>
	...
	<main>
		<section>
			<nav aria-labelledby="breadcrumbNavigation">
				...
				<ol>
					...
					<li><a href="explore-different-legislatures-uk.php" aria-current="page">Legislation for the United Kingdom</a></li>
				</ol>
			</nav>
			<h1 id="main-content-h" tabindex="-1">Legislation for the United Kingdom</h1>
		</section>
		<article>
			<p>Most of the Acts passed by UK Parliament are 'Public General Acts', which deal with matters of general public interest. UK Parliament also passes a small number of 'Private Acts', which are sub-divided into 'Local Acts' (relating to matters of local interest) and 'Personal Acts' (relating to particular persons - nowadays, these are very rare). Public and General Acts passed by the UK Parliament provide laws for the whole of the UK (England, Wales, Scotland and Northern Ireland). There are still many Acts in force that were enacted by the parliaments of the separate countries that co-existed in the British Isles before the United Kingdom of Great Britain and Ireland was formed in 1801.</p>
			<h2>Legislation that applies to the whole of the UK</h2>
			<p>Legislation made by the current and historic Parliaments and Governments of the UK that applies to the whole of the UK.</p>
			...
			<p>Legislation made by the Welsh Assembly or Welsh Parliament, Scottish Parliament, and Northern Ireland Assembly Parliament, that, although not made exclusively for the whole of the UK or by the UK Parliament and Government, may still apply in the UK.</p>
			<div class="narrow-lists">
				<h3>Primary legislation</h3>
				<ul>
		...
		<aside aria-labelledby="relatedInformation">
			...
			<ul>
				<li>
					<article>
						<a href="explore-different-legislatures-northern-ireland.php">
							<h3>Northern Ireland legislation</h3>
							<p>Legislation made by the Northern Ireland Assembly and Government.</p>
						</a>
					</article>
				</li>
				<li>
