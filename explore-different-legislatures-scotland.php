...
<head>
	<meta charset="UTF-8">
	<title>Legislation for Scotland | Different legislatures of the UK | Explore our collections | legislation.gov.uk</title>
	<noscript>
		...
		<section>
			<nav aria-labelledby="breadcrumbNavigation">
				...
				<ol>
					...
					<li><a href="explore-different-legislatures-scotland.php" aria-current="page">Legislation for Scotland</a></li>
				</ol>
			</nav>
			<h1 id="main-content-h" tabindex="-1">Legislation for Scotland</h1>
		</section>
		<article>
			<p>The current Scottish Parliament was established in 1999 by the Scotland Act 1998 to debate issues and make laws for Scotland. The Scottish Parliament has power to make laws on a range of issues that are known as devolved matters, while some issues - known as reserved matters - remain the responsibility of the UK Parliament alone. Some Acts enacted by the Old Scottish Parliament from 1424 - 1707 are still in force.</p>
			<h2>Legislation that exclusively applies to Scotland</h2>
			<p>Legislation made by the Scottish Parliament that applies exclusively to Scotland.</p>
			...
			<p>Legislation made by the UK Parliament and Government, and Historic Parliaments that, although not made exclusively for Scotland or by the Scottish Parliament, may still apply in Scotland.</p>
			<div class="narrow-lists">
				<h3>Primary legislation</h3>
				<ul>
