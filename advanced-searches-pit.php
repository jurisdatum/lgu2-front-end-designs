...
<head>
	<meta charset="UTF-8">
	<title>Point-in-time Search | Advanced Searches | legislation.gov.uk</title>
	<noscript>
...
<?php include "hdr.php" ?>
	<main class="advanced-searches">
			...
			<section>
				<nav>
					...
					<ul>
						...
						<li><a href="advanced-searches-pit.php" aria-current="page">Point in time</a></li>
        ...
        <section>
            <hgroup>
                <h1 id="main-content-h" tabindex="-1">Point-in-time Advanced Search</h1>
                <p>See how specific revised legislation stood at a particular point in time</p>
            </hgroup>
		</section>
        <section>
            <form role="search" method="get" action="/tna/search.php">
                <div class="current-approach">
                    ...
                    <fieldset class="search-date">
                        <legend><h2>Year and number</h2></legend>
                        <span><label for="from-date">Year:</label><input id="from-date" type="text" placeholder="1991" /></span>
                ...
                <div class="recommended-approach">
                    ...
                    <fieldset class="search-type">
                        ...
                        <div role="group" aria-label="Main legislation types">
                            <span><label for="primary">All revised Primary legislation</label><input id="primary" type="checkbox" checked /></span>
                            <span><label for="secondary">All revised Secondary legislation</label><input id="secondary" type="checkbox" checked /></span>
                            <span><label for="eu">All revised Legislation originating from the EU</label><input id="eu" type="checkbox" /></span>
                        </div>
                        <details>
                ...
                <fieldset class="search-pit-date">
                    <legend><h2>Point in time you want to see this legislation at</h2></legend>
                    <span><label for="pitDate">Date:</label><input type="date" id="pitDate" name="pitDate" value="<?php echo date("Y"). "-". date("m"). "-". date("d"); ?>"></span>
                </fieldset>
